...
public class MessageHandler extends Handler {
    ...
    private LampAlarmMain lampAlarmMain;
        ...
        public void handleMessage(Message msg) {
            ...
            case MESSAGE_STATE_CHANGE:
                ...
                case BluetoothMessageService.STATE_CONNECTED:
                    setStatus(lampAlarmMain.getString(R.string.title_connected_to, mConnectedDeviceName));
            ...
            case MESSAGE_WRITE:
                ...
                lampAlarmMain.getmConversationArrayAdapter().add("Me:  " + writeMessage);
                break;
            case MESSAGE_READ:
            	List<Integer> frame= (List<Integer>) msg.obj;
                if(D) Log.i(TAG, "Message arrived: " + frame.size()); 
                lampAlarmMain.updateImage(frame);
                break;
            case MESSAGE_DEVICE_NAME:
                // save the connected device's name
                mConnectedDeviceName = msg.getData().getString(DEVICE_NAME);
                Toast.makeText(lampAlarmMain.getApplicationContext(), "Connected to "
                               + mConnectedDeviceName, Toast.LENGTH_SHORT).show();
                break;
            case MESSAGE_TOAST:
                Toast.makeText(lampAlarmMain.getApplicationContext(), msg.getData().getString(TOAST),
